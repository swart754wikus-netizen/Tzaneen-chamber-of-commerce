      ...
      <Reveal>
        <section className="bg-brand-cream">
          <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6">
            ...
            <Link
              href="/apply"
              className="mt-8 inline-block rounded-full bg-brand-primary px-7 py-3 font-semibold text-white shadow-md shadow-brand-primary/10 transition-all duration-300 hover:-translate-y-0.5 hover:bg-brand-primary-dark hover:shadow-lg"
            >
              Become a Member
            </Link>
          </div>
